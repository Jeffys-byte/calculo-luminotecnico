...
# Nome do arquivo do banco de dados de usuáriosimport streamlit as st
import sqlite3
import hashlib
import json
import math
...
with st.expander("📚 Banco de Dados de Fabricantes e Luminárias (Cadastrar / Consultar)", expanded=False):
    ...
    if st.button("💾 Salvar Nova Luminária no Banco"):
...
if st.button("Gerar e Baixar Relatório Completo (.docx)", use_container_width=True):
